<script lang="ts">
	...
	const { thin, size }: { thin?: boolean; size?: number } = $props()
</script>
...
>
	...
	<g id="layer1" class="vuuui-spinner">
		...
		<g class="vuuui-circle-1" id="g33">
			...
			<path class="vuuui-line" d="m 29.35625,11.928125 0.412498,1.203125" id="path26" />
	...
	<g id="layer2" class="vuuui-duck" transform="translate(0.275,0.1375)">
		...
		<circle class="vuuui-line vuuui-eye" id="path35" cx="15.920952" cy="8.3493843" r="1.069499" />
	</g>
</svg>
