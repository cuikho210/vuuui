import "./DuckSpinner.scss";

export interface DuckSpinnerProps {
	width?: string,
	height?: string,
	thin?: boolean,
}

export const DuckSpinner = (props: DuckSpinnerProps) => {
	let className = "duck-spinner";
	if (props.thin) className += " thin";
	...
	return <>
		<svg
			...
			<g
				...
				<circle
					className="line eye"
					// style="opacity:1;fill:none;fill-opacity:1;stroke:#000000;stroke-width:0.529167;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none;stroke-opacity:1"
					id="path35"
					cx="15.920952"
					cy="8.3493843"
					r="1.069499"
